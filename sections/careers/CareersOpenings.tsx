        ...
        <div className="px-4 md:px-16 lg:px-24 xl:px-32 py-20">
            <div className="max-w-4xl mx-auto">
                ...
                <motion.div
                    ...
                    className="text-center p-12 md:p-16 rounded-2xl bg-gradient-to-br from-pink-950/30 to-transparent border border-pink-900/30"
                >
                    <div className="w-20 h-20 bg-pink-600/20 rounded-full flex items-center justify-center mx-auto mb-6">
                        <BriefcaseIcon className="w-10 h-10 text-pink-400" />
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a 
                            ...
                            className="inline-flex items-center gap-2 px-8 py-4 bg-pink-600 hover:bg-pink-700 text-white font-semibold rounded-lg transition-all"
                        >
                    ...
                    <div className="mt-8 pt-8 border-t border-pink-900/30">
                        <p className="text-slate-400 text-sm">
                            Email us at: <a href="mailto:careers@threetech.com" className="text-pink-400 hover:text-pink-300 transition-colors">careers@threetech.com</a>
                        </p>
                    </div>
                </motion.div>
