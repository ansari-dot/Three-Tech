...
export default function TestimonialSection() {
    return (
        <div id="testimonials" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Testimonials" text2="What Our Clients Say" text3="Trusted by businesses worldwide. Read what our clients have to say about working with Three Tech." />
