        ...
        <div className="px-4 md:px-16 lg:px-24 xl:px-32 py-20">
            <div className="max-w-6xl mx-auto">
                ...
                <motion.div
                    ...
                    className="rounded-2xl overflow-hidden border border-pink-900/30"
                >
                    {/* Google Maps Embed Placeholder */}
                    <div className="relative w-full h-96 bg-gradient-to-br from-pink-950/20 to-transparent">
                        <iframe
                ...
                >
                    ...
                    <a 
                        href="mailto:info@threetech.com?subject=Office Visit Request"
