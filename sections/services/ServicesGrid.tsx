                ...
                <div className="space-y-12">
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            className="group"
                        >
                            <div className="p-8 md:p-10 rounded-2xl bg-gradient-to-br from-pink-950/30 to-transparent border border-pink-900/30 hover:border-pink-700/50 transition-all duration-300">
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {service.technologies.map((tech, techIndex) => (
                                                <span 
                                                    key={techIndex}
                                                    className="px-3 py-1 text-xs bg-pink-950/50 border border-pink-800/30 rounded-full text-pink-300"
                                                >
                                                    {tech}
                                                </span>
                                            ))}
                                    ...
                                    <div>
                                        ...
                                        <a 
                                            ...
                                            className="inline-flex items-center gap-2 mt-6 text-pink-500 hover:text-pink-400 font-medium transition-colors group/link"
                                        >
                                            Get Started
