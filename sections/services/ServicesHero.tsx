...
import { CodeIcon, SmartphoneIcon, PaletteIcon, TrendingUpIcon, BrainIcon, SettingsIcon } from "lucide-react";
        ...
        <div className="relative px-4 md:px-16 lg:px-24 xl:px-32 pt-32 pb-20">
            ...
            <div className="max-w-4xl mx-auto text-center">
                ...
                >
                    ...
                    <span className="text-sm text-pink-300">Our Services</span>
                </motion.div>
