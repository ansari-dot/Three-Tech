                    ...
                    <div className="max-w-7xl mx-auto px-6 md:px-16 lg:px-24 xl:px-32 py-6">
                        <div className="flex flex-wrap items-center justify-between gap-4">
                            ...
                            >
                                <Link 
                                    to="/contact" 
                                    className="px-6 py-2.5 bg-black text-white font-semibold rounded-lg transition-all duration-300 hover:bg-gray-800"
                                >
                                    Get Started
                                </Link>
                            </motion.div>
                ...
                <div className="bg-black/50 backdrop-blur-sm">
                    <div className="max-w-7xl mx-auto px-6 md:px-16 lg:px-24 xl:px-32 py-6">
                        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-slate-400">
                            <p>&copy; {new Date().getFullYear()} SHAHSAR SOLUTIONS • All Rights Reserved</p>
