                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <span className="text-sm text-primary-300">About SHAHSAR SOLUTIONS</span>
                        </motion.div>
                        ...
                        >
                            <a 
                                href="#team" 
                                className="px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white font-semibold rounded-lg transition-all"
                            >
                                Meet Our Team
                            </a>
                            <a 
                    ...
                    <motion.div
                        ...
                        className="relative"
                    >
                        <div className="relative rounded-2xl overflow-hidden border border-primary-900/30">
                            <img 
                                src="/assets/features-showcase-1.png" 
                                alt="SHAHSAR SOLUTIONS Team" 
                                width={600} 
                                height={400}
