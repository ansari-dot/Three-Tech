    ...
    return (
        <div className="px-4 md:px-16 lg:px-24 xl:px-32 py-20">
            <div className="max-w-4xl mx-auto">
                ...
                >
                    <p className="text-lg">
                        Founded with a vision to bridge the gap between innovative technology and business success, <span className="text-primary-400 font-semibold">SHAHSAR SOLUTIONS</span> has grown into a trusted partner for businesses seeking digital transformation.
                    </p>
